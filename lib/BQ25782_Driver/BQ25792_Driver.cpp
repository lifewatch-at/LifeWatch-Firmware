...
void BQ25792::setCharge(bool EN_CHG) {
    byte tmp = readByte(REG0F_Charger_Control_0);
    Wire.beginTransmission(DEVICEADDRESS);
    Wire.write(REG0F_Charger_Control_0);
    Wire.write(tmp | 0x00100000);
    Wire.endTransmission();
}

uint8_t BQ25792::getTmp() {
    charger_status_0 status;
